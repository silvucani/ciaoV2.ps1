...
$ReportEmail.From = 'silvurez@proton.me' #Email in which you want to receice the information
$ReportEmail.To.Add('silvurez@proton.me') #Email in which you want to receive the information
