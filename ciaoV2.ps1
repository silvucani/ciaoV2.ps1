...
$ReportEmail.From = 'silvupass@yandex.com' #Email in which you want to receice the information
$ReportEmail.To.Add('silvupass@yandex.com') #Email in which you want to receive the information
